...
if( BUILD_QUANTA OR BUILD_KLINKSTATUS OR BUILD_KXSLDBG )
  ...
  if( LIBXML_FOUND )
    if( ${LIBXML_VERSION} VERSION_LESS "2.6" )
      kde_message_fatal( "libxml-2.0 version must be at least 2.6" )
    endif( )
  else( )
    kde_message_fatal( "libxml-2.0 is required, but was not found on your system" )
  endif( )
endif( )
...
if( BUILD_QUANTA OR BUILD_KLINKSTATUS OR BUILD_KXSLDBG )
  ...
  if( NOT LIBXSLT_FOUND )
    kde_message_fatal( "libxslt is required, but was not found on your system" )
  endif( )
endif( )
